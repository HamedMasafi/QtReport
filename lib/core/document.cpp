...
RDocument::RDocument(QWidget *parent)
    : QGraphicsView(parent)
{
    connect(horizontalScrollBar(),
            SIGNAL(valueChanged(int)),
            this,
            SIGNAL(horizontalValueChanged(int)));

    connect(verticalScrollBar(), SIGNAL(valueChanged(int)), this, SIGNAL(verticalValueChanged(int)));

    //    RDocumentDesigner *doc;
    //    doc = new  RDocumentDesigner ( this );
}

RDocument::RDocument(QGraphicsScene *scene, QWidget *parent)
