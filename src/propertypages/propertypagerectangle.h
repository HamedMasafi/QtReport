...
#include "ui_propertypagerectangle.h"

LEAF_BEGIN_NAMESPACE

class QColorPicker;

class PropertyPageRectangle : public PropertyPageBase, private Ui::LReportPropertyPageRectangle
{
    Q_OBJECT

public:
    PropertyPageRectangle(QWidget *parent = 0);
